window.onload = function () {
    ...
    my$doctor_right.onclick=function(){
      if(my$index<my$doctor_ul.children.length-6){
        my$index++;
        console.log(my$index);
        animation(my$doctor_ul,-my$index*204);
      }
    }
    my$case_left.onclick=function(){
      if(my$index>0){
        my$index--;
        console.log(my$index);
    ...
    my$case_right.onclick=function(){
      if(my$index<my$case_ul.children.length-4){
        my$index++;
        console.log(my$index);
        animation(my$case_ul,-my$index*264);
      }
    ...
    // .................................................封装函数.....................................................
    // 封装运动函数 a为需要移动的元素   b为要移动到的位置即元素终点位置距页面左侧的距离
    function animation(a, b) { 
      clearInterval(a.timer);
      a.timer = setInterval(function () {
        var current = a.offsetLeft;
        var step = current < b ? 10 : -10;
        current+=step;  
        if (Math.abs(b-current)>Math.abs(step)) {
